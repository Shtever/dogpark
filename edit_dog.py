...
def main():
  try:
    ...
    search = input('please enter dog\'s name: ')    #search input declared
    ...
    while record != '':                 #while not blank statement
      ...
      if dog.upper() == search.upper():
        print('match')
        print(f'{dog.upper()} found.')
        dog = input(f'Please enter new dog name: ')      #input new name
